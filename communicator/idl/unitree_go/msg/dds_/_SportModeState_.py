...
class SportModeState_(idl.IdlStruct, typename="communicator.idl.unitree_go.msg.dds_.SportModeState_"):
    stamp: 'communicator.idl.unitree_go.msg.dds_.TimeSpec_'
    ...
    path_point: types.array['communicator.idl.unitree_go.msg.dds_.PathPoint_', 10]
