...
class TwistWithCovarianceStamped_(idl.IdlStruct, typename="communicator.idl.geometry_msgs.msg.dds_.TwistWithCovarianceStamped_"):
    header: 'communicator.idl.std_msgs.msg.dds_.Header_'
    twist: 'communicator.idl.geometry_msgs.msg.dds_.TwistWithCovariance_'
